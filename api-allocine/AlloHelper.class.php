    ...
    */
    ...
    class AlloHelper
    {
        ...
        public function search($q, $page = 1, $count = 10, $sortMovies = false, array $filter = array(), &$url = null)
        {
            ...
            $q = AlloHelper::wd_remove_accents($q);
        ...
        public function movielist($filter=array('nowshowing'), $order=array('dateasc'), $count = 100, $page = 1, &$url = null)
        {
        ...
        public function showtimesByZip($zip,$radius=10, $date=null, $movieCode=null, $count = 10, $page = 1, &$url = null)
        {
            // Préréglages
            $this->set('zip', $zip);
        ...
        {
            // Préréglages
            $this->set('theaters', (string) $theaters);
            $this->set('count', (int) $count);
            $this->set('page', (int) $page);
